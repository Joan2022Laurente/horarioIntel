...
export const OFFICIAL_SYLLABUS_REGISTRY: Record<string, ParsedSyllabus> = {
  ...
  // 4. SERVICIOS CLOUD (100000ST62)
  '100000ST62': {
    id: '100000ST62',
    generalInfo: {
      courseCode: '100000ST62',
      courseName: 'SERVICIOS CLOUD',
      semester: '2026 - Ciclo 2 Agosto',
      credits: 4,
      modality: 'Presencial / Laboratorio',
      weeklyHours: 4,
      careers: ['Ingeniería de Sistemas e Informática', 'Ingeniería de Redes y Comunicaciones'],
    },
    learningGoal: 'Al finalizar el curso, el estudiante diseña y administra arquitecturas en la nube escalables, seguras y de alta disponibilidad utilizando los servicios principales de AWS y Google Cloud.',
    formula: '(15%)PC1 + (20%)EP + (15%)PC2 + (20%)PC3 + (30%)EF',
    rules: [
      'La nota mínima aprobatoria final es de 12.',
      'Laboratorios prácticos en consolas de nube (AWS Learner Lab).',
      'El Examen Final incluye sustentación de arquitectura resiliente con IaC.'
    ],
    evaluations: [
      {
        id: 'sc-pc1',
        ...
        weightPercent: 15,
        modality: 'Individual',
        observation: 'Individual. Redes VPC, subredes, tablas de enrutamiento y EC2.',
        rules: ['Semana 5', 'Ponderación 15%', 'Individual']
      },
      {
        id: 'sc-ep',
        type: 'EP',
        ...
        weightPercent: 20,
        modality: 'Individual',
        observation: 'Individual. Laboratorio práctico: ALB, Auto Scaling y Amazon S3.',
        rules: ['Semana 8', 'Ponderación 20%', 'Individual']
      },
      {
        id: 'sc-pc2',
        type: 'PC2',
        ...
        weightPercent: 15,
        modality: 'Individual',
        observation: 'Individual. Arquitectura Serverless con AWS Lambda, API Gateway y RDS.',
        rules: ['Semana 12', 'Ponderación 15%', 'Individual']
      },
      {
        id: 'sc-pc3',
        type: 'PC3',
        ...
        weightPercent: 20,
        modality: 'Grupal',
        observation: 'Grupal. Microservicios con Docker en ECS/EKS y CI/CD pipeline.',
        rules: ['Semana 15', 'Ponderación 20%', 'Grupal']
      },
      {
        id: 'sc-ef',
        type: 'EF',
        ...
        weightPercent: 30,
        modality: 'Grupal',
        observation: 'Grupal. Sustentación de infraestructura completa con IAM, Well-Architected y FinOps.',
